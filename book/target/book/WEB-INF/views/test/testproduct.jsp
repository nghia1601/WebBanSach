...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="product">Shoes</a>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">${p.loaiSach}</p>
                            <p class="bloc_left_price">${p.giaSach} $</p>
                        </div>
                    </div>
                </div>
                        ...
                        <c:forEach items="${list}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="#" title="View Product">${o.tenSach}</a></h4>
                                        <p class="card-text show_txt">${o.loaiSach}</p>
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-danger btn-block"> ${o.giaSach} $</p>
                                            </div>
                                            <div class="col">
